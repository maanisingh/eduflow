-- EduFlow Demo Data Seeding Script
-- This creates a realistic school environment with students, teachers, classes, marks, and attendance
...
DELETE FROM classes;
DELETE FROM users WHERE email NOT IN ('admin@eduflow.com', 'teacher@eduflow.com', 'student@eduflow.com');
...
-- Enroll Grade 10 students (20 students in each subject)
...
-- Insert realistic marks for all enrollments (Term 1 Test)
-- This will create varied performance: some excellent (80-100), good (70-79), average (60-69), below average (50-59), poor (<50)
INSERT INTO marks (student_id, class_id, subject_id, marks_obtained, marks_total, exam_type, exam_date)
SELECT
  e.student_id,
  e.class_id,
  cs.subject_id,
